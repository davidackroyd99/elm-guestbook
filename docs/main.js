...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{newContent: '', newName: '', notes: _List_Nil, timeZone: $elm$time$Time$utc},
...
var $author$project$Main$AddNoteWithTimestamp = function (a) {
	return {$: 'AddNoteWithTimestamp', a: a};
};
var $author$project$Note$Note = F3(
	function (a, b, c) {
		return {$: 'Note', a: a, b: b, c: c};
	});
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							notes: A2(
								$elm$core$List$cons,
								A3($author$project$Note$Note, model.newName, model.newContent, timeNow),
								model.notes)
						}),
...
var $author$project$Note$getDateString = function (dr) {
	...
	var day = $elm$core$String$fromInt(dr.day);
	return A2(
		$elm$core$String$join,
		'/',
		_List_fromArray(
...
var $author$project$Note$getPosixString = function (dp) {
	return $author$project$Note$getDateString(
		$AdrianRibao$elm_derberos_date$Derberos$Date$Core$posixToCivil(dp));
};
var $elm$html$Html$p = _VirtualDom_node('p');
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Note$noteHtml = function (note) {
	var name = note.a;
	var content = note.b;
	var ts = note.c;
	return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('My Online Guestbook')
									]))
							])),
						A2(
						$elm$html$Html$div,
						...
						A2($elm$core$List$map, $author$project$Note$noteHtml, model.notes))
					]))
			]));
};
